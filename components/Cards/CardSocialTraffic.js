    ...
    <>
      <div className="relative mb-6 flex w-full min-w-0 flex-col break-words rounded bg-white shadow-lg">
        <div className="mb-0 rounded-t border-0 px-4 py-3">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full max-w-full flex-1 flex-grow px-4">
              <h3 className="text-blueGray-700 text-base font-semibold">Social traffic</h3>
            </div>
        ...
        <div className="block w-full overflow-x-auto">
          {/* Projects table */}
          <table className="text-blueGray-700 w-full border-collapse items-center bg-transparent">
            <thead className="thead-light">
              <tr>
                ...
                <th className="bg-blueGray-50 text-blueGray-500 border-blueGray-100 min-w-140-px whitespace-nowrap border border-l-0 border-r-0 border-solid px-6 py-3 text-left align-middle text-xs font-semibold uppercase"></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="relative w-full">
                      <div className="bg-lightBlue-200 flex h-2 overflow-hidden rounded text-xs">
                        <div
                          style={{ width: '75%' }}
                          className="bg-lightBlue-500 flex flex-col justify-center whitespace-nowrap text-center text-white shadow-none"
                        ></div>
                      </div>
                    </div>
                  </div>
